...
const AssistantInfulfillmentOrders = ({ getAllInfulfillmentOrders, orders, isLoading }) => {
...
export default connect(mapStateToProps, { getAllInfulfillmentOrders })(AssistantInfulfillmentOrders)